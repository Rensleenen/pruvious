<template>
  <div class="button-wrapper">
    <div v-for="theme in themes">
      <Button  class="theme-btn" :style="{ backgroundColor: theme.color }" @click="changeTheme(theme.name)">{{ theme.name }}</Button>
    </div>
  </div>

  <div class="prime-vue-box">
    <div class="flex-auto">
...
const themes = [
  {name: "aura-dark-amber", color: "#fbbf24"},
  {name: "aura-dark-green", color: "#34d399"},
  {name: "aura-light-blue", color: "#60a5fa"},
  {name: "aura-light-purple", color: "#8B5CF6"},
];
console.log(themes);
</script>
