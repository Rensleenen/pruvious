      ...
      <div class="flex h-full flex-1 flex-col overflow-hidden px-4 pt-8">
        <div class="flex items-center gap-3">
          ...
          <div class="ml-auto flex gap-2">
            <button
              v-pruvious-tooltip="__('pruvious-dashboard', 'Mobile preview' as any)"
              @click="setMobileWidth()"
              type="button"
              class="button button-white button-square"
            >
              <PruviousIconDeviceMobile />
            </button>
            <button
              v-pruvious-tooltip="__('pruvious-dashboard', 'Tablet preview' as any)"
              @click="setTabletWidth()"
              type="button"
              class="button button-white button-square"
            >
              <PruviousIconDeviceTablet/>
            </button>
            <button
              v-pruvious-tooltip="__('pruvious-dashboard', 'Desktop preview' as any)"
              @click="setDesktopWidth()"
              type="button"
              class="button button-white button-square"
            >
              <PruviousIconDeviceDesktop />
            </button>
...
import { copyToClipboard, usePruviousClipboard } from '../../../node_modules/pruvious/dist/runtime/composables/dashboard/clipboard'
...
import { navigateToPruviousDashboardPath, usePruviousDashboard } from '../../../node_modules/pruvious/dist/runtime/composables/dashboard/dashboard'
import { pruviousDialog } from '../../../node_modules/pruvious/dist/runtime/composables/dashboard/dialog'
import { getHotkeyAction, hotkeys } from '../../../node_modules/pruvious/dist/runtime/composables/dashboard/hotkeys'
import { startMoving, stopMoving, useIsMoving } from '../../../node_modules/pruvious/dist/runtime/composables/dashboard/move'
import { pruviousToasterShow } from '../../../node_modules/pruvious/dist/runtime/composables/dashboard/toaster'
import { watchUnsavedChanges } from '../../../node_modules/pruvious/dist/runtime/composables/dashboard/unsaved-changes'
...
import { clearArray } from '../../../node_modules/pruvious/dist/runtime/utils/array'
import { resolveConditionalLogic } from '../../../node_modules/pruvious/dist/runtime/utils/conditional-logic'
import { BlockTree, type BlocksRepeaterItem } from '../../../node_modules/pruvious/dist/runtime/utils/dashboard/block-tree'
import { BlockTreeItem } from '../../../node_modules/pruvious/dist/runtime/utils/dashboard/block-tree-item'
import { defaultSortableOptions } from '../../../node_modules/pruvious/dist/runtime/utils/dashboard/defaults'
import { extractFieldKeys } from '../../../node_modules/pruvious/dist/runtime/utils/dashboard/extract-field-keys'
import { History } from '../../../node_modules/pruvious/dist/runtime/utils/dashboard/history'
import { blurActiveElement, isEditingText } from '../../../node_modules/pruvious/dist/runtime/utils/dom'
import { pruviousFetch } from '../../../node_modules/pruvious/dist/runtime/utils/fetch'
import { isNumber } from '../../../node_modules/pruvious/dist/runtime/utils/number'
import { getProperty, isObject } from '../../../node_modules/pruvious/dist/runtime/utils/object'
import { capitalize, isString, joinRouteParts, resolveCollectionPathPrefix } from '../../../node_modules/pruvious/dist/runtime/utils/string'
import { getCapabilities } from '../../../node_modules/pruvious/dist/runtime/utils/users'
import type { AddBlockOptions } from '../../../node_modules/pruvious/dist/runtime/components/misc/AddBlockPopup.vue'
...
// Function to set width based on device type
const setWidth = (width: string) => {
  // Access the iframe element by its ref
  const iframe = document.querySelector('iframe');

  if (iframe?.parentElement) {
    // Set the width attribute of the iframe
    iframe.parentElement.style.width = width;
    iframe.parentElement.style.marginInline = 'auto';
  }
};
